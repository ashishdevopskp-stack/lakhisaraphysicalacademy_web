  ...
  return (
    <section id="notifications" className="py-12 sm:py-20">
      <Container>
        ...
        {featured && (
          <ScrollFadeUp className="glass glass-sheen sheen-run relative flex flex-col overflow-hidden rounded-2xl shadow-[var(--shadow-card)] sm:flex-row">
        ...
        {/* Search & Filter */}
        <ScrollFadeUp delay={0.06} className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        {/* Cards */}
        <StaggerList className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3" staggerDelay={0.05}>
          {filtered.map((item) => (
            <StaggerItem key={item.title} className="card-flat flex flex-col p-6">
              <div
