...
const STATUS_STYLES: Record<string, string> = {
  ...
  'Limited Stock': 'bg-amber-50 text-amber-700 border border-amber-200',
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-8 max-w-5xl w-full">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500">Manage what shows up on the store page.</p>
          </div>
          <Link
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          {products.length === 0 ? (
            <div className="p-10 text-center">
              ...
              <Link href="/admin/products/new" className="text-sm text-indigo-600 hover:underline">
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0 sm:ml-4 pl-[3.75rem] sm:pl-0">
                    <span className={'text-xs px-2.5 py-1 rounded-full ' + (STATUS_STYLES[product.availability] ?? STATUS_STYLES['Out of Stock'])}>
