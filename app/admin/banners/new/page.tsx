...
import { createBanner } from '@/app/lib/action/banners'
    ...
    <div className="min-h-screen bg-slate-100/70 text-slate-900 flex flex-col lg:flex-row">
      ...
      <main className="flex-1 p-4 sm:p-6 lg:p-10 max-w-4xl w-full mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <span className="text-xs font-bold text-slate-500">Add New Home Banner</span>
        </div>
        ...
        >
          <div className="border-b border-slate-100 pb-4">
            ...
            <h1 className="text-2xl font-black text-slate-900">Add New Home Banner (नया बैनर)</h1>
            <p className="text-xs font-semibold text-slate-500 mt-0.5">
              Upload banner image, set target links, and pick display ratio.
            </p>
          </div>
