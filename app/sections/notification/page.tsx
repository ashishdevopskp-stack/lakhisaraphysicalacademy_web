      ...
      <Container>
        ...
        >
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            <Button href="#notifications" variant="primary" icon={Megaphone}>
...
/* =========================================================
   3. Notification Listings — sample data, wire to your CMS/API
   ========================================================= */
...
const NOTIFICATION_CATEGORY_LABELS = CATEGORIES.map((c) => c.label);
...
function NotificationListings() {
  ...
  return (
    <section id="notifications" className="py-16 sm:py-24">
      <Container>
        ...
        {featured && (
          <motion.div
            ...
            className="glass glass-sheen sheen-run relative mt-8 flex flex-col overflow-hidden rounded-2xl shadow-[var(--shadow-card)] sm:flex-row"
          >
      ...
      <Container>
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            ...
            <Button href="#notifications" variant="ghost" icon={Megaphone}>
