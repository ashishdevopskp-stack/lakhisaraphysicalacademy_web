...
const inputClasses =
  "w-full rounded-lg border border-line bg-bg px-4 py-2.5 text-[14px] text-text outline-none transition-colors focus:border-line-strong placeholder:text-text-muted";
...
function FileInput({
  ...
  return (
    <div>
      <FieldLabel label={label} required={required} />
      <label className="flex cursor-pointer items-center gap-3 rounded-lg border border-dashed border-line bg-bg px-4 py-3 text-[13px] text-text-muted transition-colors hover:border-line-strong">
        <UploadCloud size={16} className="shrink-0 text-signal" />
...
function CheckboxRow({
  ...
  return (
    <button
      ...
      className="flex w-full items-start gap-3 rounded-lg border border-line bg-bg px-4 py-3 text-left transition-colors hover:border-line-strong"
    >
      <span
...
function AdmissionHero() {
  return (
    <section className="relative overflow-hidden border-b border-line pb-12 pt-14 sm:pb-16 sm:pt-20">
      <Container>
        <motion.div
        ...
        >
          ...
          <h1 className="mt-5 max-w-[20ch] text-[32px] sm:text-[42px] lg:text-[48px]">
...
function SuccessScreen({
  ...
  return (
    <motion.div
      ...
      className="mx-auto max-w-[60ch] rounded-2xl border border-line bg-bg-raised px-6 py-14 text-center sm:px-14"
    >
      <PartyPopper size={28} className="mx-auto text-signal" />
      <h2 className="mt-4 text-[26px] sm:text-[32px]">Congratulations!</h2>
      ...
      <div className="mt-8 space-y-2 rounded-xl border border-line bg-bg p-5 text-left text-[13px] text-text-muted">
        <p>
...
export default function Admission() {
  ...
  return (
    <>
      ...
      <section id="admission" className="py-12 sm:py-16">
        <Container>
          <div className="mx-auto max-w-[760px]">
            ...
            <div className="mt-8 flex items-center gap-3 border-b border-line pb-5">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-line-strong bg-bg-raised">
                <StepIcon size={17} className="text-signal" />
              </span>
            ...
            <div className="mt-10 flex items-center justify-between gap-3 border-t border-line pt-6">
              <button
                ...
                onClick={handleBack}
                disabled={step === 0}
                className="flex items-center gap-1.5 text-[14px] font-medium text-text-muted transition-colors hover:text-text disabled:opacity-0"
              >
                <ChevronLeft size={16} />
                Back
              </button>
              ...
              {isLastStep ? (
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-signal px-5 py-2.5 text-[14px] font-medium text-on-signal transition-opacity disabled:opacity-40"
                >
                ...
                <button
                  type="button"
                  onClick={handleNext}
                  className="flex items-center gap-2 rounded-lg bg-signal px-5 py-2.5 text-[14px] font-medium text-on-signal"
                >
                  Next
