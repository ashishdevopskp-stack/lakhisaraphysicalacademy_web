...
function VideoGrid() {
  ...
  return (
    <section id="videos" className="border-b border-line py-16 sm:py-24">
      <Container>
        ...
        {featured && (
          <motion.div
            ...
            className="mt-8 flex flex-col overflow-hidden rounded-xl border border-line bg-bg-raised sm:flex-row"
          >
            <div className="flex aspect-video items-center justify-center border-b border-line bg-bg sm:w-[55%] sm:border-b-0 sm:border-r">
              <PlayCircle size={36} className="text-signal" />
            </div>
            <div className="flex flex-1 flex-col justify-center p-6">
              <span className="inline-flex w-fit items-center gap-1 rounded-full border border-line-strong bg-bg px-2.5 py-1 text-[10px] font-medium uppercase tracking-wide text-signal">
                Featured
              </span>
              <h3 className="mt-3 text-[18px] font-semibold text-text">
                {featured.title}
              </h3>
          ...
          {rest.map((video, i) => (
            ...
            >
              <div className="flex aspect-video items-center justify-center rounded-lg border border-line-strong bg-bg">
                <PlayCircle size={28} className="text-signal" />
              </div>
    ...
    <section className="py-16 sm:py-24">
      <Container>
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-[48ch] text-[15px] text-text-muted">
