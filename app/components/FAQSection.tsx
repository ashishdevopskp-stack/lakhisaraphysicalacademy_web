...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "मॉर्निंग बैच का समय सुबह 5:00 AM से 7:30 AM तक है (गांधी मैदान / स्टेडियम)। इवनिंग बैच शाम 4:30 PM से 6:30 PM तक चलता है। रविवार को स्पेशल टाइम ट्रायल और मेडिकल टेस्ट कराया जाता है।",
  ...
  },
  {
    ...
    answer: "हाँ! एकेडमी परिसर के निकट पूरी तरह से सुरक्षित हॉस्टल, पौष्टिक डाइट प्लान के साथ मेस, आरओ वाटर, और 24 घंटे स्टडी रूम की सुविधा उपलब्ध है।",
    category: "Hostel",
  },
  {
