...
export const config = {
  matcher: [
    /*
     * Match all request paths except static files, images, sitemaps, robots & manifests
     */
    '/((?!_next/static|_next/image|sitemap\\.xml|robots\\.txt|site\\.webmanifest|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|xml|txt|webmanifest)$).*)',
  ],
}